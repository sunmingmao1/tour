...
public class SystemStatueBarUtil {
    ...
    public static void setStatusBarColorL(Activity activity, int statusColor) {
    ...
    /**
     * 4.4-5.0系统 修改状态栏背景颜色的方法,用前判断版本号
     * @param activity
     * @param statusColor
     */
     ...
     * 5.0以上状态栏透明
     * @param activity
     * @param hideStatusBarBackground  是否为全透明 true:全透明  false:半透明
     */
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    static void translucentStatusBarL(Activity activity, boolean hideStatusBarBackground) {
        Window window = activity.getWindow();
        //添加Flag把状态栏设为可绘制模式
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    public static void setStatusBarColor(Activity activity, int statusColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setStatusBarColorL(activity,statusColor);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
